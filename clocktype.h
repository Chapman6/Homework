...
public:
	...
	void getTime(int& years, int& months, int& days, int& hours, int& minutes, int& seconds) const;
	...
	clockType(int years, int months, int days, int hours, int minutes, int seconds);
